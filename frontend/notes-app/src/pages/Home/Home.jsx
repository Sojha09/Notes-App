...
import emptyimage from "../../assets/emptynote.jpg";
    ...
    <>
      ...
      <div className="container mx-auto">
        {allNotes.length > 0 ? (
          ...
          <EmptyCard
            imgSrc={isSearch ? NoDataImg : emptyimage}
            message={
              isSearch
                ? `Oops! No Notes Matched Your Search.`
                : `Start Creating Your First Note! Click the 'Add' button to note down your thoughts,ideas,work and reminders.
               Let's Get Started!!
             `
            }
          />
